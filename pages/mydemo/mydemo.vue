<template>
  <view class="template-about tn-safe-area-inset-bottom">
    ...
    <view class="top-backgroup">
		<view class="tn-flex tn-flex-row-between tn-flex-col-center tn-margin-bottom" style="padding: 53px 20px 20px 20px ">
		...
		<view class="home-head1 heads">
		</view>
		<view class="home-head2 heads">
		</view>
    ...
    <view class="about__wrap" style="margin-top: -454rpx;">
	  ...
	  <image  src="https://note.youdao.com/yws/public/resource/59dee57d6f3be28543801f1539475cd1/xmlnote/WEBRESOURCE10ca050a91c1f1407338500b47971c75/38" style="height:30rpx;width:100%;margin-top:50px;" mode="widthFix"></image>
...
<style lang="scss" scoped>
  ...
  .home {
	...
	// linear-gradient(to right, #758ba1, #688098);
